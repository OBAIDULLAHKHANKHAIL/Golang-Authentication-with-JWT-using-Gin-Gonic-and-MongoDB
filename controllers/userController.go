...
import (
	...
	"github.com/OBAIDULLAHKHANKHAIL/golang-jwt-project/database"
	"github.com/OBAIDULLAHKHANKHAIL/golang-jwt-project/models"
	...
	helper "github.com/OBAIDULLAHKHANKHAIL/golang-jwt-project/helpers"
)
...
func Login() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		helper.UpdateAllTockens(token, refreshToken, foundUser.User_id)
...
func GetUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// if err != nil {
		// 	c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while converting Atoi"})
		// }
